...
export function WhatsAppButton() {
  return (
    <Link
      ...
      className="group fixed bottom-6 left-6 z-50 flex items-center gap-2.5 rounded-full bg-[#25D366] py-3 pl-3.5 pr-5 shadow-lg ring-4 ring-[#25D366]/20 transition-all duration-300 hover:scale-105 hover:shadow-xl"
    >
      {/* Pulse ring */}
      ...
      {/* Label */}
      <span className="relative z-10 text-sm font-semibold leading-none text-white">
        Order via WhatsApp
      </span>
    </Link>
  );
